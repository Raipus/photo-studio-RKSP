			...
			<main className='grid justify-items-center'>
				{loading ? (
					...
					<div className='m-10 grid justify-items-center'>
						...
						<h1 className='mb-3 mt-32 justify-self-center text-2xl'>Вход</h1>
						<form
						...
						>
							...
							<button
								type='submit'
								className='hover:scale-102 mt-20 rounded-md bg-[#3D8361] px-5 py-2 text-xl text-white duration-300 hover:bg-[#2F6A4E]'
							>
								Вход
							</button>
						</form>
