...
export {
    ...
    CountryCode, E164Number, Examples, Extension, MetadataJson, NationalNumber, NumberFormat, NumberFound, NumberFoundLegacy, NumberingPlan, NumberType, ParseError, PhoneNumber, ValidatePhoneNumberLengthResult
};
